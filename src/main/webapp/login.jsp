    ...
    function webLogin() {
        if (checkLoginInfo()) {
            ...
            $.ajax({
                ...
                data: {userName: loginname, userPwd: password},
...
<h1>JHZ旅行社管理系统登陆注册<sup>2017</sup></h1>
...
<div class="login" style="margin-top:50px;">
        ...
        <div class="web_login" id="web_login">
            ...
            <div class="login-box">
                ...
                <div class="login_form">
                    <form action="<%=request.getContextPath()%>/user/login.action" name="loginform"
    ...
    <div class="qlogin" id="qlogin" style="display: none; ">
        ...
        <div class="web_login">
            <form name="form2" id="regUser" accept-charset="utf-8" action="<%=request.getContextPath()%>/user/reg"
                  method="post">
